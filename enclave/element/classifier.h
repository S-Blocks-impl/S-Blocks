...
class Classifier : public BatchElement { public:
    ...
    int configure(stlpmtx_std::vector<String> &conf, ErrorHandler *errh);// CLICK_COLD;
    ...
    static void parse_program(Classification::Wordwise::Program &prog,stlpmtx_std::vector<String> &conf, ErrorHandler *errh);
