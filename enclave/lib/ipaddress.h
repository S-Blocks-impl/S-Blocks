...
#ifndef _ENCLAVE_IPADDRESS_H
#define _ENCLAVE_IPADDRESS_H
...
class IPAddressArg;
//template <typename T> class stlpmtx_std::vector;
...
template<> struct DefaultArg<stlpmtx_std::vector<IPAddress> > : public IPAddressArg {};
